...
import { View, Text, StyleSheet, FlatList, Image, TouchableOpacity, Pressable, Modal, Alert, Platform } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={colors.linearGradient} style={styles.gradient}>
        <ScreenHeader
          ...
          backIcon={<ArrowLeft size={24} color={colors.textLight} />}
