...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Platform, StatusBar, Image, Alert } from 'react-native';
...
const getStyles = (colors: ColorsType) => StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: colors.theme === 'dark' ? '#0F172A' : colors.primary },
  container: { flex: 1 },
  header: {
    flexDirection: 'row',
