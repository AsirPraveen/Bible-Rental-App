...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Platform, StatusBar, Alert, Modal, Image, Animated } from 'react-native';
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#022C22' },
  container: { flex: 1 },
  header: {
    flexDirection: 'row',
