...
import { View, StyleSheet, Text, FlatList, TouchableOpacity, ActivityIndicator, Platform, Switch, Alert } from 'react-native';
...
export default function SuperAdminOrgDetail({ route, navigation }: any) {
  ...
  const fetchOrgDetail = async () => {
    try {
      setLoading(true);
      const res = await apiClient.get(`/api/superadmin/organizations/${orgId}`);
