...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, SafeAreaView, ActivityIndicator, Modal, TextInput, Switch, Platform, StatusBar, RefreshControl } from 'react-native';
