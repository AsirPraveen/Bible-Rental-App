...
import { HistoryScreen as History } from '@/screens/History';
import { WishListScreen as Wishlist } from '@/screens/WishList';
import { GeneratedImagesScreen as GeneratedImages } from '@/screens/Bible';
import { GeneratedPdfsScreen } from '@/screens/Songs';
import { NotificationSettingsScreen as NotificationSettings } from '@/screens/Settings';
...
type DrawerStackParamList = {
  CreateFellowship: undefined;
  ChatScreen: {
    fellowshipId: string;
    fellowshipName: string;
    fellowshipType?: string;
    fellowshipIcon?: string;
  };
};
        ...
        {!isGuest && activeOrg?.features?.upperRoom !== false && (
          <View style={drawerStyles.upperRoomSection}>
            ...
            {loadingFellowships ? (
              ...
              fellowships.map((fellowship: Fellowship) => (
                <TouchableOpacity
                  key={fellowship._id}
  ...
  return (
    <Drawer.Navigator
      ...
      screenOptions={{
        ...
        // Renamed from sceneContainerStyle in @react-navigation/drawer v7.
        sceneStyle: {
          backgroundColor: colors.primary,
        },
      }}>
