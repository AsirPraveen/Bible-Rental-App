...
import { View, Text, StyleSheet, TouchableOpacity, Platform, Animated, Modal, TextInput, ScrollView, Image } from 'react-native';
    ...
    <SafeAreaView style={styles.safeArea}>
      <LinearGradient colors={colors.theme === 'dark' ? theme : colors.linearGradient} style={styles.container}>
        ...
        <ScreenHeader
          ...
          title={`Survival (Wave ${wave})`}
          backIcon={<MaterialCommunityIcons name="arrow-left" size={28} color="#C7D2FE" />}
          spacerWidth={28}
        />
        ...
        <Modal
          ...
          statusBarTranslucent visible={endGameState === 'defeat'} transparent animationType="fade">
