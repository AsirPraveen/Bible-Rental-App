...
import { View, Text, StyleSheet, Switch, ScrollView, TouchableOpacity, ActivityIndicator, Alert, Platform, Pressable } from 'react-native';
...
const NotificationSettings = () => {
    ...
    try {
      ...
      if (response.data.status === 'Ok') {
        ...
        if (deviceZone && response.data.data?.timezone !== deviceZone) {
          apiClient.put(`/api/users/notification-settings`,
  ...
  const toggleSetting = async (key: keyof NotificationSettingsState) => {
    ...
    try {
      ...
      await apiClient.put(`/api/users/notification-settings`,
