...
const SongPdfGenerator = ({ route, navigation }: any) => {
  ...
  const loadSavedPdf = async () => {
    ...
    try {
      setLoading(true);
      const res = await apiClient.get(`/api/generated-pdfs/${pdfId}`);
...
SaveLayoutDialog.displayName = 'SaveLayoutDialog';
...
PrintDocDialog.displayName = 'PrintDocDialog';
